...
const EVENTS: IEvent[] = [
  {
    ...
    time: '10:00 am',
    price: 599.99,
    imageUrl: '/app/assets/images/cucumber.png',
    // location: {
    //   address: '1057 DT',
    //   city: 'London',
    //   country: 'England'
    // },
    onlineUrl: 'www.socgen.com/cucumberBDD',
    sessions: [
      {
        id: 1,
        name: 'Using Cucumber BDD',
        presenter: 'Peter Bacon Darwin',
        duration: 1,
        level: 'Intermediate',
        abstract: `Learn all about the new pipes in Cucumber BDD, both 
      ...
      {
        id: 3,
        name: 'Cucumber BDD Performance Metrics',
        presenter: 'Rob Wormald',
        duration: 2,
        level: 'Advanced',
        abstract: `Cucumber BDD Performance is hot. In this session, we'll see 
      ...
      {
        id: 4,
        name: 'Cucumber BDD Look Ahead',
        presenter: 'Brad Green',
        duration: 2,
        level: 'Advanced',
        abstract: `Even though CucumberBDD 5 is still 6 years away, we all want 
          to know all about it so that we can spend endless hours in meetings 
          debating if we should use CucumberBDD 4 or not. This talk will look at 
          CucumberBDD 6 even though no code has yet been written for it. We'll 
      ...
      {
        id: 5,
        name: 'Basics of CucumberBDD 4',
        presenter: 'John Papa',
        duration: 2,
        level: 'Beginner',
        abstract: `It's time to learn the basics of CucumberBDD 4. This talk 
          will give you everything you need to know about CucumberBDD 4 to 
  ...
  },
  {
    ...
    time: '9:00 am',
    price: 950.00,
    imageUrl: '/app/assets/images/webservices.png',
    location: {
      address: 'Pritech, 3rd Floor',
      city: 'Bangalore',
      country: 'India',
    },
    sessions: [
      {
        id: 1,
        name: 'Testing Web-Services 4 Workshop',
        presenter: 'Pascal Precht & Christoph Bergdorf',
        duration: 4,
        level: 'Beginner',
        abstract: `In this 6 hour workshop you will learn not only how to test Web-Services 4, 
      ...
      {
        id: 2,
        name: 'Web-Services 4 and Firebase',
        presenter: 'David East',
        duration: 3,
        level: 'Intermediate',
        abstract: `In this workshop, David East will show you how to use Web-Services with the new
          ultra-real-time 5D Firebase back end, hosting platform, and wine recommendation engine.`,
        voters: ['bradgreen', 'igorminar', 'johnpapa'],
      },
      {
        id: 3,
        name: 'Reading the Web-Services 4 Source',
        presenter: 'Patrick Stapleton',
        duration: 2,
        level: 'Intermediate',
        abstract: `Web-Services 4's source code may be over 25 million lines of code, but it's really 
  ...
  },
  {
    id: 3,
    name: 'Angular-Js 2.0',
    date: new Date('5/4/2017'),
    time: '9:00 am',
    price: 759.00,
    imageUrl: '/app/assets/images/angularjs.png',
    location: {
      address: 'Voyager',
      city: 'Bangalore',
      country: 'India',
  ...
  },
  {
    ...
    time: '8:00 am',
    price: 800.00,
    imageUrl: '/app/assets/images/python.png',
    location: {
      address: 'Victor - 11',
      city: 'Bangalore',
      country: 'India',
    ...
    sessions: [
      ...
      {
        id: 2,
        name: 'World Peace and Python',
        presenter: 'US Secretary of State Zach Galifianakis',
        duration: 2,
        level: 'Beginner',
        abstract: `Python has been used in most of the major peace brokering that has
          happened in the last decade, but there is still much we can do to remove all
          war from the world, and Python will be a key part of that effort.`,
        voters: ['bradgreen', 'igorminar', 'johnpapa'],
      },
      {
        id: 3,
        name: 'Using Python with Androids',
        presenter: 'Dan Wahlin',
        duration: 3,
        level: 'Advanced',
        abstract: `Androids may do everything for us now, allowing us to spend all day playing 
          the latest Destiny DLC, but we can still improve the massages they give and the handmade
          brie they make using Python 4. This session will show you how.`,
  ...
  },
  {
    ...
    time: '9:00 am',
    price: 400.00,
    imageUrl: '/app/assets/images/scala.png',
    location: {
      address: 'SocGen HQ',
      city: 'Paris',
      country: 'France',
    ...
    sessions: [
      {
        id: 1,
        name: 'Gambling with Scala',
        presenter: 'John Papa',
        duration: 1,
        level: 'Intermediate',
        abstract: `No, this talk isn't about slot machines. We all know that 
          Scala is used in most waiter-bots and coke vending machines, but
          ...
          are now determined by Scala code.`,
        voters: ['bradgreen', 'igorminar'],
      },
      {
        id: 2,
        name: 'Scala 4 in 60ish Minutes',
        presenter: 'Dan Wahlin',
        duration: 2,
        level: 'Beginner',
        abstract: `Get the skinny on Scala 4 for anyone new to this great new technology.
          Dan Wahlin will show you how you can get started with Scala in 60ish minutes, 
          guaranteed!`,
        voters: ['bradgreen', 'igorminar', 'johnpapa'],
      },
    ],
